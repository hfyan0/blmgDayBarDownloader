...
###################################################
# java -jar $BIN -f EBITDA -f PE_RATIO -f PB_RATIO -f CURR_ENTP_VAL -f BEST_EV $SYMBOLSTR -symsuffix " $SYM_SUFFIX" -start 19001001 -end 20201231 -adjusted false -o $OUTFOLDER/
...
# java -jar $BIN -f DVD_SH_LAST $SYMBOLSTR -symsuffix " $SYM_SUFFIX" -start 19001001 -end 20201231 -adjusted false -o $OUTFOLDER/
# java -jar $BIN -f EQY_DVD_YLD_IND $SYMBOLSTR -symsuffix " $SYM_SUFFIX" -start 19001001 -end 20201231 -adjusted false -o $OUTFOLDER/
